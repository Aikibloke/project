...
data<-read.csv("Degree Distribution by Phylostratum TE.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  annotation_logticks()+
  labs(title="Degree distribution of genes associated to phylostratum within the TE",
...
setwd("B:/Sabrina_2019/")
data<-read.csv("Betweeness Distribution by Phylostratum TE.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Betweeness distribution of genes associated to phylostratum within the TE",
...
setwd("B:/Sabrina_2019/")
data<-read.csv("Bridgeness Distribution by Phylostratum TE.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Bridgeness distribution of genes associated to phylostratum within the TE",
...
setwd("B:/Sabrina_2019/")
data<-read.csv("Community Centrality Distribution by Phylostratum TE.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Community Centrality distribution of genes associated to phylostratum in the TE",
...
library(readxl)
Bridgeness_vs_Centrality_TE <- read_excel("Bridgeness vs Centrality TE.xlsx")

ggplot(Bridgeness_vs_Centrality_TE, aes(x=Centrality, y=Bridgeness))+
  geom_point()+
...
library(readxl)                                                                              
setwd("B:/Sabrina_2019/")
data<-read_excel("Bridgeness vs Centrality TE.xlsx")
...
rownames(data)<-as.character(1:6482)
data2<-data
...
write.table(data, file = "TE3 date party.txt",sep = "\t",row.names = FALSE)
