...
genes <-read.csv("Yan Mural TE surface gene direct partners.csv")
setwd("B://Affiliated people/Sabrina_2019/hypernetwork/")
...
png("surfaceome_mxmt_muralTEST.png",height=1000,width=1000)
...
# write.csv(mat,file="surfaceome_mxmt_clustergenesmuraLTEST2.csv")
writeClipboard(mat)
write.table(mat, file = "surfaceome_mxmt_clustergenesmuralTEST2.txt",sep = "\t",row.names = FALSE)
