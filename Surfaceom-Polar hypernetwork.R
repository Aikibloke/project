...
genes <-read.csv("Yan Polar TE surface gene direct partners.csv")
setwd("B://Affiliated people/Sabrina_2019/hypernetwork/")
...
png("surfaceome_mxmt_polarTEST.png",height=1000,width=1000)
...
# write.csv(mat,file="surfaceome_mxmt_clustergenespolar2.csv")
writeClipboard(mat)
write.table(mat, file = "surfaceome_mxmt_clustergenespolar2.txt",sep = "\t",row.names = FALSE)
