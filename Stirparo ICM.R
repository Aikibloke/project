...
data<-read.csv("Degree Distribution by Phylostratum Stiparo ICM specific.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_y_continuous(trans = "log10", breaks = c(1e-03, 1e-02, 1e-01, 1e+00))+
  scale_x_continuous(trans = "log10", breaks = c(1, 10, 100, 1000))+
  expand_limits(x = c(0,1500))+
  annotation_logticks()+
  labs(title="Degree distribution of genes associated to phylostratum within the ICM (stiparo)",
...
data<-read.csv("Bridgeness Distribution by Phylostratum stiparo ICM specific control.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  annotation_logticks()+
  labs(title="Bridgeness distribution of genes within the ICM stiparo specific control",
...
data<-read.csv("Centrality Distribution by Phylostratum stiparo ICM specific control.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Community Centrality distribution of genes the ICM stiparo specific control",
...
data<-read_excel("Bridgeness vs Centrality stiparo ICM specific (with genes).xlsx")
...
highlight.gene <- "ETS1"
data$highlight <-ifelse(data$genes == highlight.gene, "highlight", "normal")
textdf <- data[data$genes == highlight.gene]
...
rownames(data)<-as.character(1:3493)
data2<-data
...
ggplot(data, aes(x=Centrality, y=Bridgeness))+
  ...
  scale_x_continuous(trans = 'log10')+
  ggtitle("ICM stiparo")
write.table(data, file = "ICM stiparo specific control date party.txt",sep = "\t",row.names = FALSE)
...
setwd("B:/Affiliated people/Sabrina_2019/Degree Distributions/")
data<-read.csv("Degree Distribution by HAR stiparo ICM specific.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  annotation_logticks()+
  labs(title="Degree distribution of HAR genes within the ICM stiparo specific",
       x="Degree",y="Cumulative Frequency",fill="Cell line")+
  theme(plot.title = element_text(size=22),axis.title = element_text(size=18),axis.text = element_text(size=18),legend.text = element_text(size=12),legend.title = element_text(size=12))
# scale_color_manual(values=c("#56B4E9", "#E69F00", "#999999","#458B00"))+
# geom_vline(xintercept = mean(dls[[1]]$degree),col="#56B4E9",size=1.5)+
...
setwd("B:/Affiliated people/Sabrina_2019/Bridgeness Distributions/")
data<-read.csv("Bridgeness Distribution by HAR stiparo ICM specific control.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Bridgeness distribution of HAR genes within the ICM stiparo specific control",
       x="Bridgeness",y="Cumulative Frequency",fill="Cell line")+
  theme(plot.title = element_text(size=22),axis.title = element_text(size=18),axis.text = element_text(size=18),legend.text = element_text(size=12),legend.title = element_text(size=12))
# scale_color_manual(values=c("#56B4E9", "#E69F00", "#999999","#458B00"))+
# geom_vline(xintercept = mean(dls[[1]]$degree),col="#56B4E9",size=1.5)+
...
setwd("B:/Affiliated people/Sabrina_2019/Community Centrality Distribution")
data<-read.csv("Centrality Distribution by HAR stiparo ICM specific control.csv")
# data<-read.csv("ICM network for final bridgeness dist.csv")
# data<-read.csv("ICM network for final centrality dist.csv")
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Community Centrality distribution of har genes within the ICM stiparo control",
...
library(readxl)                                                                              
setwd("B:/Affiliated people/Sabrina_2019/Bridgeness vs Centrality/")
data<-read_excel("Bridgeness vs Centrality HAR stiparo ICM control.xlsx")
...
data<-data.frame(data)
rownames(data)<-as.character(1:4950)
data2<-data
data2$Bridgeness<-log10(data2$Bridgeness)
data2$Centrality<-log10(data2$Centrality)
data2<-data2[which(data2$Bridgeness!="-Inf"),]
...
write.table(data, file = "ICM stiparo specific control HAR date party.txt",sep = "\t",row.names = FALSE)

library(readxl)                                                                              
setwd("B:/Affiliated people/Sabrina_2019/Bridgeness vs Centrality")
data<-read_excel("Bridgeness vs Centrality HAR stiparo TE specific.xlsx")
...
ggplot(data, aes(x=Centrality, y=Bridgeness))+
  ...
  scale_y_continuous(trans='log10')+
  scale_x_continuous(trans = 'log10')+
  ggtitle("Har genes ICM stiparo specific control")
...
setwd("B:/Affiliated people/Sabrina_2019/Lambert paper/")
data<-read.csv("TE BCL6.csv")

colnames(data)<-c("Phylostratum","distribution")
...
ggplot(data, aes(x= Phylostratum, y= distribution))+
  geom_bar(stat= Phylostratum)

ct<-list()
for(i in 1:length(levels(data$Phylostratum))){
  ct[[i]]<-count(dls[[i]]$distribution)
  ct[[i]][,2]<-ct[[i]][,2]/sum(ct[[i]]$freq)
  ct[[i]]<-ct[[i]][order(-ct[[i]]$x),]
  ct[[i]]$cumsum<-cumsum(ct[[i]]$freq)
}
...
for(i in 2:length(levels(data$Phylostratum))){
  Phylostratum<-c(Phylostratum,rep(levels(data$Phylostratum)[i],length(ct[[i]]$x)))
}
dat$phylo<-HAR
...
a<-ggplot(dat,aes(x=x,y=cumsum))+
  ...
  scale_x_continuous(trans = "log10")+
  annotation_logticks()+
  labs(title="Bridgeness distribution of human accelerated genes within the ICM stiparo",
       x="Bridgeness",y="Cumulative Frequency",fill="Cell line")+
  theme(plot.title = element_text(size=22),axis.title = element_text(size=18),axis.text = element_text(size=18),legend.text = element_text(size=12),legend.title = element_text(size=12))
# scale_color_manual(values=c("#56B4E9", "#E69F00", "#999999","#458B00"))+
# geom_vline(xintercept = mean(dls[[1]]$degree),col="#56B4E9",size=1.5)+
